...
fun WhyUpdateBottomSheet(
    ...
    NovaModalBottomSheet(
        ...
        WhyUpdateBottomSheetContent(onCloseClick = onDismissRequest)
    }
}

@Composable
private fun WhyUpdateBottomSheetContent(
    onCloseClick: () -> Unit
) {
    Column(
        modifier = Modifier
        ...
        NovaText(
            text = stringResource(RCommon.string.asset_details_balance_why_update_title),
        ...
        NovaText(
            text = stringResource(RCommon.string.asset_details_balance_why_update_description),
...
@Preview
@Composable
private fun WhyUpdateBottomSheetContentPreview() {
    PolkadotTheme {
        NovaBottomSheetSurface {
            WhyUpdateBottomSheetContent(onCloseClick = {})
        }
    }
}
