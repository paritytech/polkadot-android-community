...
@Composable
fun BlockConfirmationContent(
    type: ChatMenuType.BlockConfirmation,
    onConfirm: () -> Unit,
    onCancel: () -> Unit
) {
    Column(
        ...
        NovaText(
            text = stringResource(RCommon.string.chat_block_user_question, type.username),
        ...
        NovaText(
            text = stringResource(RCommon.string.chat_block_user_confirmation),
        ...
        Row(horizontalArrangement = Arrangement.spacedBy(12.dp)) {
            ...
            PolkadotTextButton(
                modifier = buttonModifier,
                text = stringResource(RCommon.string.common_block),
