package io.paritytech.polkadotapp.feature_become_citizen_impl.domain.videorecord
 ...
 */
internal fun Quality.getAspectRatio(quality: Quality): Int {
    return when {
 ...
 */
internal fun Quality.getAspectRatioString(quality: Quality, portraitMode: Boolean): String {
