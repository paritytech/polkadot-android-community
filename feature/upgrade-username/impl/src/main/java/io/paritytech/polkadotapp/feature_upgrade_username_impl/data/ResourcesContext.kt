...
internal fun BandersnatchContext.Companion.resources(networkSuffix: ByteArray): BandersnatchContext {
    return personhoodProductContext(networkSuffix, DerivationIndex32.fromUInt(RESOURCES_INDEX))
}
