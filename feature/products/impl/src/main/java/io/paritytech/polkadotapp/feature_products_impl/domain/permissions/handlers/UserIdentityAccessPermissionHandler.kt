...
class UserIdentityAccessPermissionHandler @Inject constructor(
    ...
    override suspend fun isGranted(productId: ProductId, permission: ProductPermission.UserIdentityAccess): Boolean {
        return repository.isGranted(productId, permission)
    }

    override suspend fun request(productId: ProductId, permission: ProductPermission.UserIdentityAccess): Boolean {
    ...
    override suspend fun revoke(productId: ProductId, permission: ProductPermission.UserIdentityAccess) {
