...
class BalanceAccessPermissionHandler @Inject constructor(
    ...
    override suspend fun isGranted(productId: ProductId, permission: ProductPermission.BalanceAccess): Boolean {
        return repository.isGranted(productId, permission)
    }

    override suspend fun request(productId: ProductId, permission: ProductPermission.BalanceAccess): Boolean {
    ...
    override suspend fun revoke(productId: ProductId, permission: ProductPermission.BalanceAccess) {
