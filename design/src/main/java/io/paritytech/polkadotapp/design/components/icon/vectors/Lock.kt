...
val NovaIcons.Lock: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Lock",
        defaultWidth = 24.dp,
        defaultHeight = 24.dp,
        ...
        path(fill = SolidColor(Color(0xFF000000))) {
            ...
            close()
            moveTo(9f, 6.5f)
            curveTo(9f, 4.84f, 10.34f, 3.5f, 12f, 3.5f)
            curveTo(13.66f, 3.5f, 15f, 4.84f, 15f, 6.5f)
            verticalLineTo(8.5f)
            horizontalLineTo(9f)
            verticalLineTo(6.5f)
            close()
...
private fun LockPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = NovaIcons.Lock, contentDescription = null)
    }
}
