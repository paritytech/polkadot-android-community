...
// TODO replace with the real Valkyrie-generated icon (heroicons-solid/trash)
val NovaIcons.Trash: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Trash",
        defaultWidth = 24.dp,
        defaultHeight = 24.dp,
        ...
        path(
            ...
            curveTo(10.875f, 1.509f, 11.436f, 1.5f, 12f, 1.5f)
            curveTo(12.564f, 1.5f, 13.125f, 1.509f, 13.685f, 1.527f)
            curveTo(15.288f, 1.578f, 16.5f, 2.914f, 16.5f, 4.478f)
            close()
            moveTo(10.363f, 3.026f)
            curveTo(10.907f, 3.009f, 11.453f, 3f, 12f, 3f)
            curveTo(12.548f, 3f, 13.093f, 3.009f, 13.637f, 3.026f)
            curveTo(14.391f, 3.05f, 15f, 3.684f, 15f, 4.478f)
            verticalLineTo(4.591f)
            curveTo(14.008f, 4.531f, 13.007f, 4.5f, 12f, 4.5f)
            curveTo(10.993f, 4.5f, 9.992f, 4.531f, 9f, 4.591f)
            verticalLineTo(4.478f)
            curveTo(9f, 3.684f, 9.609f, 3.05f, 10.363f, 3.026f)
            close()
