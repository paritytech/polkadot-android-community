...
val NovaIcons.MessageUnreadFilled: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "MessageUnreadFilled",
        defaultWidth = 24.dp,
        defaultHeight = 24.dp,
        viewportWidth = 24f,
        viewportHeight = 24f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            curveTo(14f, 6.76f, 16.24f, 9f, 19f, 9f)
            curveTo(20.13f, 9f, 21.16f, 8.61f, 22f, 7.98f)
            close()
            moveTo(16f, 4f)
