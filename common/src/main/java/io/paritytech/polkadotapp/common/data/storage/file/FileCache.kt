...
internal class InternalFileSystemCache @Inject constructor(
    ...
    private suspend fun FileProvider.readCache(fileName: String): String? =
    ...
    private suspend fun FileProvider.writeCache(fileName: String, value: String) =
        withContext(Dispatchers.IO) {
            fileMutex.withLock {
                val file = getFileInInternalCacheStorage(fileName)
