package io.paritytech.polkadotapp.common.utils.graph

import io.paritytech.polkadotapp.common.utils.MultiMapList
...
typealias EdgeWeight = Int

interface WeightedEdge<N> : Edge<N> {
    fun weightForAppendingTo(path: Path<WeightedEdge<N>>): EdgeWeight
}
