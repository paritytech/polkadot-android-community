 ...
 * {@link FragmentNavigator} which allows not only to replace old
...
public class AddFragmentNavigator extends Navigator<AddFragmentNavigator.Destination> {
    ...
    public boolean popBackStack() {
        ...
        if (mFragmentManager.isStateSaved()) {
            Timber.i("Ignoring popBackStack() call: FragmentManager has already"
                + " saved its state");
            return false;
        }
    ...
    public NavDestination navigate(@NonNull Destination destination, @Nullable Bundle args,
        ...
        if (mFragmentManager.isStateSaved()) {
            Timber.i("Ignoring navigate() call: FragmentManager has already"
                + " saved its state");
            return null;
        }
    ...
    public static class Destination extends NavDestination {
        ...
        public void onInflate(@NonNull Context context, @NonNull AttributeSet attrs) {
            ...
            String className = fragmentNavigatorArray.getString(androidx.navigation.fragment.R.styleable.FragmentNavigator_android_name);
            if (className != null) {
