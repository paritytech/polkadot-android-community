...
/**
 * Host for the global navigation bar: resolves its own [RootNavBarViewModel] and renders the overlay.
 * The [navController]'s current entry is the "screen entered" signal the bar resets its posture on.
 */
@Composable
