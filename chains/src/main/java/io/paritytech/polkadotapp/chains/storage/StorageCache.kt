...
interface StorageCache {
    suspend fun isPrefixInCache(
        prefixKey: String,
        chainId: String,
    ): Boolean

    suspend fun isFullKeyInCache(
        fullKey: String,
        chainId: String,
    ): Boolean
    ...
    suspend fun insertPrefixEntries(
        entries: List<StorageEntry>,
        prefixKey: String,
        chainId: String,
    )

    suspend fun removeByPrefix(
        prefixKey: String,
        chainId: String,
    )
...
suspend fun StorageCache.insertPrefixEntries(
    entries: Map<String, String?>,
    prefix: String,
    chainId: String,
) {
