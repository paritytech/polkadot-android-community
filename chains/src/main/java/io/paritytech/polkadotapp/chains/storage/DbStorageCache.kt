...
internal class DbStorageCache(
    private val storageDao: StorageDao,
) : StorageCache {
    override suspend fun isPrefixInCache(
        prefixKey: String,
        chainId: String,
    ): Boolean {
    ...
    override suspend fun isFullKeyInCache(
        fullKey: String,
        chainId: String,
    ): Boolean {
    ...
    override suspend fun insertPrefixEntries(
        entries: List<StorageEntry>,
        prefixKey: String,
        chainId: String,
    ) {
    ...
    override suspend fun removeByPrefix(
        prefixKey: String,
        chainId: String,
    ) {
    ...
    override suspend fun removeByPrefixExcept(
        prefixKey: String,
    ...
    override suspend fun observeEntries(
        keys: List<String>,
        chainId: String,
    ): Flow<List<StorageEntry>> {
    ...
    override suspend fun getEntry(
        key: String,
        chainId: String,
    ): StorageEntry = observeEntry(key, chainId).first()

    override suspend fun filterKeysInCache(
        keys: List<String>,
        chainId: String,
    ): List<String> {
...
private fun mapStorageEntryFromLocal(storageEntryLocal: StorageEntryLocal) =
